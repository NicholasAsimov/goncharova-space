...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for Firstmovr x Colgate-Palmolive.", kind: "image", width: 1366, height: 464 },
    { src: image2, alt: "Case study image 2 from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1366, height: 464 },
    { src: image3, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image4, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image5, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1492, height: 1500 },
    { src: image6, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image7, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image8, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1470, height: 1500 },
    { src: image9, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image10, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image11, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
    { src: image12, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 },
  ],
  blocks: [
  { type: "image", media: { src: image1, alt: "Cover image for Firstmovr x Colgate-Palmolive.", kind: "image", width: 1366, height: 464 } },
  { type: "image", media: { src: image2, alt: "Case study image 2 from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1366, height: 464 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image3, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image4, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image5, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1492, height: 1500 } },
  { type: "image", media: { src: image6, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image7, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image8, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1470, height: 1500 } },
  { type: "image", media: { src: image9, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image10, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image11, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "image", media: { src: image12, alt: "Design Portfolio from Firstmovr x Colgate-Palmolive.", kind: "image", width: 1500, height: 1500 } },
  { type: "divider" },
