...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for Onsual.", kind: "image" },
    { src: image2, alt: "Landing page from Onsual.", kind: "image" },
    { src: image3, alt: "Onboarding flow from Onsual.", kind: "image" },
    { src: image4, alt: "Dashboard flow from Onsual.", kind: "image" },
    { src: image5, alt: "Finance flow from Onsual.", kind: "image" },
    { src: image6, alt: "Profile flow from Onsual.", kind: "image" },
  ],
  blocks: [
  { type: "heading", level: 2, content: [{ text: "Cover" }] },
  { type: "image", media: { src: image1, alt: "Cover image for Onsual.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image2, alt: "Landing page from Onsual.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image3, alt: "Onboarding flow from Onsual.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image4, alt: "Dashboard flow from Onsual.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image5, alt: "Finance flow from Onsual.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image6, alt: "Profile flow from Onsual.", kind: "image" } },
  { type: "divider" },
