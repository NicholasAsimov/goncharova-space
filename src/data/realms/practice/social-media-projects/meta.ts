...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for Social Media Projects.", kind: "image", width: 1920, height: 1066 },
    { src: image2, alt: "Vila Muhr from Social Media Projects.", kind: "image", width: 1890, height: 1296 },
    { src: image3, alt: "Tutookatu shop from Social Media Projects.", kind: "image", width: 1920, height: 1080 },
    { src: image4, alt: "Tutookatu shop from Social Media Projects.", kind: "image", width: 1920, height: 1080 },
    { src: image5, alt: "Groworking from Social Media Projects.", kind: "image", width: 1080, height: 1080 },
    { src: image6, alt: "Groworking from Social Media Projects.", kind: "image", width: 1206, height: 1206 },
    { src: image7, alt: "Groworking from Social Media Projects.", kind: "image", width: 1220, height: 1218 },
    { src: image8, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1210 },
    { src: image9, alt: "Groworking from Social Media Projects.", kind: "image", width: 1222, height: 1212 },
    { src: image10, alt: "Groworking from Social Media Projects.", kind: "image", width: 1645, height: 829 },
    { src: image11, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1216 },
    { src: image12, alt: "Groworking from Social Media Projects.", kind: "image", width: 1222, height: 1210 },
    { src: image13, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1226 },
    { src: image14, alt: "Groworking from Social Media Projects.", kind: "image", width: 1206, height: 1206 },
    { src: image15, alt: "Groworking from Social Media Projects.", kind: "image", width: 1210, height: 1212 },
    { src: image16, alt: "Groworking from Social Media Projects.", kind: "image", width: 1204, height: 1206 },
  ],
  blocks: [
  { type: "heading", level: 1, content: [{ text: "Vila Muhr" }] },
  { type: "image", media: { src: image1, alt: "Cover image for Social Media Projects.", kind: "image", width: 1920, height: 1066 } },
  { type: "image", media: { src: image2, alt: "Vila Muhr from Social Media Projects.", kind: "image", width: 1890, height: 1296 } },
  ...
  { type: "image", media: { src: image3, alt: "Tutookatu shop from Social Media Projects.", kind: "image", width: 1920, height: 1080 } },
  { type: "image", media: { src: image4, alt: "Tutookatu shop from Social Media Projects.", kind: "image", width: 1920, height: 1080 } },
  ...
  { type: "image", media: { src: image5, alt: "Groworking from Social Media Projects.", kind: "image", width: 1080, height: 1080 } },
  { type: "image", media: { src: image6, alt: "Groworking from Social Media Projects.", kind: "image", width: 1206, height: 1206 } },
  ...
  { type: "divider" },
  { type: "image", media: { src: image7, alt: "Groworking from Social Media Projects.", kind: "image", width: 1220, height: 1218 } },
  { type: "image", media: { src: image8, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1210 } },
  { type: "image", media: { src: image9, alt: "Groworking from Social Media Projects.", kind: "image", width: 1222, height: 1212 } },
  { type: "image", media: { src: image10, alt: "Groworking from Social Media Projects.", kind: "image", width: 1645, height: 829 } },
  { type: "image", media: { src: image11, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1216 } },
  { type: "image", media: { src: image12, alt: "Groworking from Social Media Projects.", kind: "image", width: 1222, height: 1210 } },
  { type: "image", media: { src: image13, alt: "Groworking from Social Media Projects.", kind: "image", width: 1218, height: 1226 } },
  { type: "image", media: { src: image14, alt: "Groworking from Social Media Projects.", kind: "image", width: 1206, height: 1206 } },
  { type: "image", media: { src: image15, alt: "Groworking from Social Media Projects.", kind: "image", width: 1210, height: 1212 } },
  { type: "image", media: { src: image16, alt: "Groworking from Social Media Projects.", kind: "image", width: 1204, height: 1206 } },
  ],
};
