...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image2, alt: "Onboarding flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image3, alt: "Goal setting flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image4, alt: "Goal setting flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image5, alt: "Complete task flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image6, alt: "Mindfulness flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image7, alt: "Community flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
    { src: image8, alt: "Profile section flow from CuriVerse.", kind: "image", width: 2048, height: 1152 },
  ],
  blocks: [
  { type: "heading", level: 2, content: [{ text: "Cover" }] },
  { type: "image", media: { src: image1, alt: "Cover image for CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image2, alt: "Onboarding flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image3, alt: "Goal setting flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image4, alt: "Goal setting flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image5, alt: "Complete task flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image6, alt: "Mindfulness flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image7, alt: "Community flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image8, alt: "Profile section flow from CuriVerse.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  ],
};
