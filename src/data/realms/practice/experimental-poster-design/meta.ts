...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for Experimental Poster Design.", kind: "image" },
    { src: image2, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" },
    { src: image3, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" },
    { src: image4, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" },
    { src: image5, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" },
    { src: image6, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" },
    { src: image7, alt: "Claustrophobia from Experimental Poster Design.", kind: "image" },
    { src: image8, alt: "Social Anxiety from Experimental Poster Design.", kind: "image" },
    { src: image9, alt: "Panic Disorder from Experimental Poster Design.", kind: "image" },
  ],
  blocks: [
  { type: "image", media: { src: image1, alt: "Cover image for Experimental Poster Design.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "image", media: { src: image2, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" } },
  { type: "divider" },
  ...
  { type: "divider" },
  { type: "image", media: { src: image3, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" } },
  { type: "image", media: { src: image4, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" } },
  { type: "image", media: { src: image5, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" } },
  { type: "image", media: { src: image6, alt: "Understanding Anxiety: You Are Not Alone from Experimental Poster Design.", kind: "image" } },
  { type: "divider" },
  { type: "heading", level: 2, content: [{ text: "Claustrophobia" }] },
  { type: "image", media: { src: image7, alt: "Claustrophobia from Experimental Poster Design.", kind: "image" } },
  ...
  { type: "image", media: { src: image8, alt: "Social Anxiety from Experimental Poster Design.", kind: "image" } },
  ...
  { type: "image", media: { src: image9, alt: "Panic Disorder from Experimental Poster Design.", kind: "image" } },
