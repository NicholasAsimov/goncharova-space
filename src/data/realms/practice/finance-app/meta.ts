...
const project: PracticeProject = {
  ...
  media: [
    { src: image1, alt: "Cover image for Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image2, alt: "Information Architecture from Finance App.", kind: "image", width: 2048, height: 1281 },
    { src: image3, alt: "High Fidelity from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image4, alt: "Design System from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image5, alt: "Typography & Colors from Finance App.", kind: "image", width: 2048, height: 1357 },
    { src: image6, alt: "Typography & Colors from Finance App.", kind: "image", width: 2048, height: 2726 },
    { src: image7, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image8, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image9, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image10, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image11, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image12, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
    { src: image13, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 },
  ],
  blocks: [
  { type: "heading", level: 2, content: [{ text: "Cover" }] },
  { type: "image", media: { src: image1, alt: "Cover image for Finance App.", kind: "image", width: 2048, height: 1152 } },
  ...
  { type: "image", media: { src: image2, alt: "Information Architecture from Finance App.", kind: "image", width: 2048, height: 1281 } },
  { type: "divider" },
  { type: "heading", level: 2, content: [{ text: "High Fidelity" }] },
  { type: "image", media: { src: image3, alt: "High Fidelity from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  { type: "heading", level: 2, content: [{ text: "Design System" }] },
  { type: "image", media: { src: image4, alt: "Design System from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "divider" },
  { type: "heading", level: 2, content: [{ text: "Typography & Colors" }] },
  { type: "image", media: { src: image5, alt: "Typography & Colors from Finance App.", kind: "image", width: 2048, height: 1357 } },
  { type: "image", media: { src: image6, alt: "Typography & Colors from Finance App.", kind: "image", width: 2048, height: 2726 } },
  { type: "divider" },
  { type: "heading", level: 2, content: [{ text: "UI" }] },
  { type: "image", media: { src: image7, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image8, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image9, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image10, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image11, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image12, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  { type: "image", media: { src: image13, alt: "UI from Finance App.", kind: "image", width: 2048, height: 1152 } },
  ],
};
